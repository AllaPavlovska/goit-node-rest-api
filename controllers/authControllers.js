...
import authServices from "../services/authServises.js";
...
const signup = async (req, res) => {
  ...
  const isEmail = await authServices.findUser({ email });
...
const signin = async (req, res) => {
  ...
  const comparePass = await authServices.validatePassword(
    password,
    user.password
  );
...
const updateSubscription = async (req, res) => {
  ...
  const user = await authServices.updateUser({ _id: id }, { subscription });
